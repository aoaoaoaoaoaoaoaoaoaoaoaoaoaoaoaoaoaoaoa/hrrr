...
indexed vector basemap. Wind direction is stamped from an application-owned 3D
bronze-quill die by the same build-time Foundry that makes Poolrooms chrome.
